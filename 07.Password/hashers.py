...
class PBKDF2PasswordHasher(BasePasswordHasher):
    ...
    def encode(self, password, salt, iterations=None):
        ...
        print ('xxxxx in encode() iterations:', iterations)
        salt = "2m0dhbDZQ4vIbwujHL8ygc"
        hash = pbkdf2(password, salt, iterations, digest=self.digest)
        print ('xxxxx in encode() hash:', hash)
        str1 = base64.b64encode(hash)
        print ('base64.b64encode(hash):', str1)
        str2 = str1.decode("ascii")
        print ('str1.decode("ascii"):', str2)
        hash = base64.b64encode(hash).decode("ascii").strip()
        print ('base64.b64encode(hash).decode("ascii").strip()', hash)
